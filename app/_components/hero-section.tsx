    ...
    <section {...props}>
      <div className={myFont.className}>
        <motion.div
          ...
          className="grid grid-cols-1 mx-auto max-w-screen-xl relative w-full  md:grid-cols-2 gap-2 md:gap-20"
        >
          <div>
            ...
            <h1 className="text-[31px] text-white leading-[1.29] tracking-[-0.022rem] space-y-2 mb-6 mt-2 select-text ">
              <span className="relative top-[3px] md:top-0 ">
                Software Engineer
              </span>
              <br />
                ...
                >
                  ...
                  <g id="line">
                    ...
                    <line
                      ...
                      fill="none"
                      stroke="#000"
                      stroke-dasharray="0 0 3.9396 3.9396"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      stroke-width="2"
                    />
