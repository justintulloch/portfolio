          ...
          <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div className="flex">
                  ...
                  <ul className="flex flex-wrap gap-2">
                    {languages.map((language, index) => (
                      <li key={index} className="text-xs font-bold text-white bg-zinc-400 px-2 py-1 rounded-md">{language}</li>
                    ))}
                  </ul>
                </div>
            <div className="mx-auto max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
              <div className="flex flex-col-reverse">
                <div className="mt-4">
                    <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">{props.project.title}</h1>
                    <h2 className="sr-only">// languages</h2>
                </div>
              </div>
